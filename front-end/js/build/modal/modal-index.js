...
function () {
  ...
  _createClass(UserRouter, null, [{
    key: "User",
    value: function User(data) {
      var typeofUser = data.isadmin === true ? 'admin' : 'staff';
...
var _helpers = _interopRequireDefault(require("../clients/helpers/helpers"));

var _SessionStorage = _interopRequireDefault(require("../clients/helpers/SessionStorage"));

var _UserRouter = _interopRequireDefault(require("../clients/Router/UserRouter"));
...
function () {
  function CheckModal1() {
    ...
    contentContainer.appendChild(this.content); //  document.getElementById('modalId').addEventListener('click', this.close.bind(this));
  }
...
document.getElementById('signUp').addEventListener('click', function () {
  ...
  createUser.addEventListener('click', function () {
    ...
    if (_validators["default"].ValidateTextInput(FirstName, Indicator) && _validators["default"].ValidateTextInput(LastName, Indicator) && _validators["default"].validateEmail(Email, Indicator) && _validators["default"].validatePassword(Password, Indicator) && _validators["default"].validateConfirmPassword(Password, ConfirmPassword, Indicator)) {
...
document.getElementById('signIn').addEventListener('click', function () {
  ...
  m.open();
  var myhelper = new _helpers["default"]();
  var Indicator = document.getElementById('indicator');
  var Email = document.getElementById('email');
  var Password = document.getElementById('password');
  ...
  Login.addEventListener('click', function () {
    var url = 'https://bankaandela.herokuapp.com/api/v1/auth/signin';
    bar.style.display = 'block';

    if (_validators["default"].validateEmail(Email, Indicator) && _validators["default"].validatePassword(Password, Indicator)) {
      bar.style.display = 'block';
      Login.disabled = true;
      var UserData = {
        email: Email.value,
      ...
      postdata.post(url, UserData).then(function (result) {
        ...
        if (result.status === 200) {
          ...
          _SessionStorage["default"].storeData('UserData', result.Data);

          console.log("my result is ".concat(result.Data));

          _UserRouter["default"].User(result.Data); //  window.location.href = './html/user.html';
...
},{"../../js/clients/validator/validators":5,"../clients/Router/UserRouter":1,"../clients/helpers/SessionStorage":2,"../clients/helpers/fetch":3,"../clients/helpers/helpers":4}]},{},[6]);
